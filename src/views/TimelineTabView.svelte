...
<div class="h-[calc(100vh-6rem)]" bind:this={container}>
  <VirtualList width="100%" {height} itemCount={data.length} itemSize={490}>
    <div slot="item" let:index let:style {style}>
      <!-- Letter: {data[index]}, Row: #{index} -->

      <div
        class="p-5 mb-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700"
      >
        ...
        <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
          <li>
            ...
            >
              <img
                class="ml-3 mb-3 w-12 h-12 rounded-full sm:mb-0"
